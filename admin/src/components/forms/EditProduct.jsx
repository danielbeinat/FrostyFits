...
export const EditProduct = ({ product, onClose, onUpdate }) => {
  ...
  useEffect(() => {
    if (product) {
      ...
      const sizesForType = getSizesForType(product.type);
      setSizes(sizesForType || []);
      setApplyDiscount((product.discount || 0) > 0);
    }
  }, [product]);
  ...
  const updateProduct = async (e) => {
    ...
    try {
      ...
      // Update product
      const updateResponse = await fetch(`${API_URL}/api/products/update`, {
        method: "POST",
        headers: {
          Accept: "application/json",
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl">
          ...
          <form onSubmit={updateProduct} className="p-8 space-y-8">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400 text-sm">
                              {image ? image.name : "Click to change"}
                            </p>
                          </div>
                        </div>
                      ) : (
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              <button
                type="button"
                onClick={onClose}
                className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold rounded-xl transition-all duration-200"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-3 bg-gray-900 hover:bg-black disabled:bg-gray-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl disabled:cursor-not-allowed transition-all duration-200 flex items-center space-x-3"
              >
                {isUploading ? (
                  <>
                    <svg
